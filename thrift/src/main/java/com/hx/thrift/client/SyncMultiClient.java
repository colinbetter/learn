 ...
 * Description:
 */
public class SyncMultiClient {
    private static final Logger LOG = LoggerFactory.getLogger(SyncMultiClient.class);
    ...
    public static void main(String[] args) {
        ...
        TMultiplexedProtocol multiplexedProtocol = new TMultiplexedProtocol(protocol, "additionService");
        AdditionService.Client client = new AdditionService.Client(multiplexedProtocol);
        try {
            transport.open();
