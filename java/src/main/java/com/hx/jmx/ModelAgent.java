...
public class ModelAgent {
    private String MANAGED_CLASS_NAME = "com.hx.jmx.Car";
    private MBeanServer mBeanServer = null;

    public ModelAgent() {
        mBeanServer = ManagementFactory.getPlatformMBeanServer();//MBeanServerFactory.createMBeanServer();
    }
    ...
    public static void main(String[] args) {
        ...
        ObjectName objectName = agent.createObjectName(domain + ":name=MyCar");
